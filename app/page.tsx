  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      <section className="mb-8">
        ...
        <p>
          Η Αστική μη κερδοσκοπική εταιρεία «Θεατρικοί Ορίζοντες» και η ομάδα του θεάτρου Εξ Αρχής, στοχεύουν από το 1991 στο
          άρτιο καλλιτεχνικό και αισθητικό αποτέλεσμα. Εντός και εκτός Αθηνών στόχος μας είναι πάντα η τέχνη και όπως θα έλεγε ο
          Κάρολος Κουν το να «Κάνουμε Θέατρο για την ψυχή μας»
        </p>
      </section>
      <section className="mb-8">

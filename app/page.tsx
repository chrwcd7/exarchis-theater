      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div>
          <section className="mb-8">
            ...
            <p className="mb-4">
              Το θέατρο Εξ Αρχής δημιουργήθηκε το 2004 από την ΑΜΚΕ «Θεατρικοί Ορίζοντες» στα Εξάρχεια, όπου βρίσκεται μέχρι
              σήμερα. Στο χώρο στεγάζονται θέατρο και εργαστήρι θεάτρου. Επιπλέον, φιλοξενούνται πολιτιστικές εκδηλώσεις
              θεατρικού, μουσικού, αλλά και εικαστικού ενδιαφέροντος. Για όσους αγαπούν την τέχνη και αναζητούν μια ευκαιρία να
              συνδεθούν με τον μαγικό κόσμο του θεάτρου, το Εξ Αρχής και το δημιουργικό του εργαστήρι ανοίγουν τις πόρτες τους.
              Εκεί, η φαντασία συναντά την έκφραση, και οι ιστορίες ζωντανεύουν μέσα από την κίνηση, τη φωνή και την ψυχή.
            </p>
            <p>
              Αν αγαπάτε την τέχνη του θεάτρου, είτε ως θεατές είτε ως υποψήφιοι σπουδαστές της υποκριτικής, σας περιμένουμε στο
              Θέατρο Εξ Αρχής.
            </p>
          </section>
          <section className="mb-8">

        ...
        <section className="bg-card p-6 rounded-lg shadow-md flex flex-col items-center sm:items-start">
          ...
          <div className="line-clamp-5 hover:line-clamp-none">
            <p className="mb-4">
              ...
              Δραματική Σχολή Αθηνών του Βασίλη Ρίτσου και στο τμήμα Θεατρικών Σπουδών του Πανεπιστημίου Πατρών, απ' όπου και
              αποφοίτησε το 2001. Έχει συνεργαστεί με τους: Αλίκη Βουγιουκλάκη (Καμπαρέ σκηνοθεσία Δημήτρης Ποταμίτης). Θανάση
              Βέγγο, Νίκο Ρίζο, Κώστα Βουτσά, Χάρρυ Κλυνν, Σωτήρη Μουστάκα, Μάρω Κοντού, Μάρθα Καραγιάννη, Ντίνο Ηλιόπουλο, (σε
              επιθεωρήσεις). Είναι ιδρυτικό στέλεχος του ΔΗ.ΠΕ.ΘΕ. Αγρινίου με συμμετοχές στα έργα: Κουραμπίδες του Γιώργου
              Χασάπογλου (Σκηνοθεσία. Ραΐα Μουζενίδου), Έχω στόχο Κύριε Πρόεδρε του Γιώργου Χαραλαμπίδη (Σκηνοθεσία: Γιώργος
              Χαραλαμπίδης), Η Αυλή των Θαυμάτων του Ιάκωβου Καμπανέλλη (Σκηνοθεσία: Νίκος Παπακωνσταντίνου), Χοηφόροι του
              Αισχύλου (Σκηνοθεσία: Κωνσταντίνος Μάριος). το Στραβόξυλο του Δημήτρη Ψαθά (Σκηνοθεσία: Πάνος Παπαϊωάννου).
              Συνεργάστηκε με το Θέατρο Κύβος στο έργο του Εντουάρντο ντε Φιλίππο Αχ αυτά τα Φαντάσματα! (Σκηνοθεσία: Γ.
              Γεωργιάδης), με το Θέατρο Μι νώα στο έργο του Ντίνου Σπυρόπουλου Γιάφκα Πορτοκάλι (Σκηνοθεσία: Χάρρυ Κλύνν), με το

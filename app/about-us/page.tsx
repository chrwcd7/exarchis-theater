    ...
    <>
      ...
      <section className="mb-8">
        <p className="mb-4">
          ...
          με τα οποία καταπιάνεται, πως ενδιαφέρεται για την τέχνη του θεάτρου ολιστικά.
        </p>
        <p>
          ...
          Ορίζοντες. Στα σχέδια της ΑΜΚΕ τώρα, βρίσκεται η στήριξη των σύγχρονων νεοελληνικών έργων, κάτι που θα επιδιωχθεί να
          επιτευχθεί μέσω του έργου «Λύκοι» του Ντίνου Σπυρόπουλου.
        </p>
      </section>
      <div className="flex flex-col gap-4">
        <section className="bg-card p-6 rounded-lg shadow-md flex flex-col items-center sm:items-start">
          ...
          <p className="line-clamp-5 hover:line-clamp-none">
            ...
            στο έργο «Αυγά της Στρουθοκαμήλου» του Χ. Ναούμ, στον «Ουρανό Κατακόκκινο» της Λ. Αναγνωστάκη και στα
            «Παντρολογήματα» του Ν. Γκόγκολ - μεταξύ άλλων. Το 2004 ίδρυσε το εργαστήρι θεάτρου και Θέατρο Εξ Αρχής που εδρεύει
            στα Εξάρχεια. Τηλεοπτικά, μία από τις τελευταίες δουλειές της ήταν το “Milky Way” του σκηνοθέτη Βασίλη Κεκάτου.
          </p>
        </section>
        <section className="bg-card p-6 rounded-lg shadow-md flex flex-col items-center sm:items-start">

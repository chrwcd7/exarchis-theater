  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-4 lg:flex-row">
        <section className="flex-1 bg-card p-6 rounded-lg shadow-md flex flex-col items-center sm:items-start">
          <h1 className="text-4xl font-bold mb-4 text-center">Ελένη Τσακάλου</h1>
          <Image src={eleniTsakalouImg} alt="Ελένη Τσακάλου" className="w-40 h-40 mb-4 rounded-full object-cover" />
          <p className="text-lg leading-relaxed">
        ...
        <section className="flex-1 bg-card p-6 rounded-lg shadow-md flex flex-col items-center sm:items-start">
          ...
          <Image src={dinosSpyropoulosImg} alt="Ντίνος Σπυρόπουλος" className="w-40 h-40 mb-4 rounded-full object-cover" />
          <p className="text-lg leading-relaxed">
